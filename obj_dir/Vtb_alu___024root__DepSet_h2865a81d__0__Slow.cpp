...
VL_ATTR_COLD void Vtb_alu___024root___eval_static__TOP(Vtb_alu___024root* vlSelf);
...
VL_ATTR_COLD void Vtb_alu___024root___eval_static(Vtb_alu___024root* vlSelf) {
    ...
    // Body
    Vtb_alu___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void Vtb_alu___024root___eval_static__TOP(Vtb_alu___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_alu___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->tb_alu__DOT__test_count = 0U;
    vlSelf->tb_alu__DOT__pass_count = 0U;
    vlSelf->tb_alu__DOT__fail_count = 0U;
}
...
#endif
            VL_FATAL_MT("tb/tb_alu.sv", 8, "", "Settle region did not converge.");
        }
...
void Vtb_alu___024root___act_comb__TOP__0(Vtb_alu___024root* vlSelf);
...
VL_ATTR_COLD void Vtb_alu___024root___dump_triggers__act(Vtb_alu___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] tb_alu.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtb_alu___024root___dump_triggers__nba(Vtb_alu___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] tb_alu.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtb_alu___024root___ctor_var_reset(Vtb_alu___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_alu__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->tb_alu__DOT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->tb_alu__DOT__opcode = VL_RAND_RESET_I(4);
    vlSelf->tb_alu__DOT__operand1 = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__operand2 = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__operand3 = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__result = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__overflow = VL_RAND_RESET_I(1);
    vlSelf->tb_alu__DOT__test_count = 0;
    vlSelf->tb_alu__DOT__pass_count = 0;
    vlSelf->tb_alu__DOT__fail_count = 0;
    vlSelf->tb_alu__DOT__dut__DOT__add_result_ext = VL_RAND_RESET_Q(33);
    vlSelf->tb_alu__DOT__dut__DOT__mul_result_ext = VL_RAND_RESET_Q(64);
    vlSelf->tb_alu__DOT__dut__DOT__fma_mul_result = VL_RAND_RESET_Q(64);
    vlSelf->tb_alu__DOT__dut__DOT__fma_result_ext = VL_RAND_RESET_Q(33);
    vlSelf->tb_alu__DOT__dut__DOT__mul_ovf = VL_RAND_RESET_I(1);
    vlSelf->tb_alu__DOT__dut__DOT__add_ovf = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb_alu__DOT__rst_n__0 = VL_RAND_RESET_I(1);
